...
<body class="dashboard-page">
        ...
        <aside id="sidebar">
            ...
            <div class="sidebar-scroll">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a href="historial-clases.php" class="sidebar-link selected">
                            ...
                            <table id="tablaHistorialClases" class="table table-striped table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="border-0">Nombre de Instructor</th>
                                        <th scope="col" class="border-0">Apellido de Instructor</th>
                                        <th scope="col" class="border-0">Teléfono de Instructor</th>
    ...
    <script src="js/historial-clases-estudiante.js"></script>
