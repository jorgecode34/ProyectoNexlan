...
<body class="dashboard-page">
        ...
        <aside id="sidebar">
            ...
            <div class="sidebar-scroll">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item separar-items">
                        <a href="estudiante-material.php" class="sidebar-link selected">
            ...
            <main class="content px-3 py-2">
                <div class="container-fluid">
                    <div class="mb-3">
                        ...
                        <p class="text-center text-lg-start">Aquí material de estudio para el examen teórico.</p>
    ...
    <script src="js/estudiante-material.js"></script>
