                                    ...
                                    <div class='modal-content'>
                                        ...
                                        <div class='modal-body'>
                                            <form action='modificar-estudiante.php' method='post'>
                                                ...
                                                <div class='mb-3'>
                                                    <label for='pass{$estudiante['documento']}' class='form-label'>Teórico</label>
                                                        <select class='form-select' id='teorico{$estudiante['documento']}' name='teorico' value='{$estudiante['teorico']}' required'>
