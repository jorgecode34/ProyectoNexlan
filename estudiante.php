...
<body class="dashboard-page">
                    ...
                    <div class="mb-3">
                        ...
                        <div id="header-tabla" class="d-flex flex-wrap flex-lg-nowrap justify-content-between align-items-center shadow bg-body-tertiary">
                            ...
                            <div class="me-auto p-2 w-100 w-lg-auto">
                                <button class="btn btn-primary w-100 w-lg-auto" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">Agregar estudiante</button>
                            </div>
                            <!-- Barra de busqueda -->
                            <div class="p-2 w-100 w-lg-auto">
                                <input type="search" id="searchInput" class="form-control w-100 w-lg-auto" placeholder="Buscar estudiantes...">
                            </div>
                            <!-- Boton limitar -->
                        ...
                        <div class="table-responsive shadow">
                            <table id="tablaPersonas" class="table table-striped table-hover">
                                <thead>
                                    <tr>
                                        <th scope="col" class="border-0">ID Estudiante</th>
                                        ...
                                        <th scope="col" class="border-0">Teórico</th>
        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="alta-estudiante.php" method="post" onsubmit="disableSubmitButton()">
                        <div class="row">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-info" onclick="rellenarCamposEstudiante()">Rellenar con datos aleatorios</button>
    ...
    <div class="modal fade" id="modifModal" tabindex="-1" aria-labelledby="modalModificarLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalModificarLabel">Modificar Estudiante</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="formModificarEstudiante" method="post" onsubmit="guardarCambios(event)">
                        ...
                        <div class="form-floating mb-3">
                            <select class="form-select" id="txtTeorico" name="teorico" required>
                                <option value="Pendiente">Pendiente</option>
                                <option value="Aprobado">Aprobado</option>
                            </select>
                            <label for="txtTeorico">Teórico</label>
                        </div>
                </div>
                <div class="modal-footer">
    ...
    <div class="modal fade" id="modalBaja" tabindex="-1" aria-labelledby="modalBajaLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form id="formBajaEstudiante" method="post" onsubmit="confirmarBaja(event)">
