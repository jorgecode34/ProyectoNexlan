...
<body class="dashboard-page">
        ...
        <aside id="sidebar">
            ...
            <div class="sidebar-scroll">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a href="historial-clases-instructor.php" class="sidebar-link selected">
                ...
                <div class="container-fluid">
                    <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-center justify-content-lg-start">
                            <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" fill="currentColor" class="bi bi-clipboard-data me-2" viewBox="0 0 16 16">
                                <path d="M4 11a1 1 0 1 1 2 0v1a1 1 0 1 1-2 0zm6-4a1 1 0 1 1 2 0v5a1 1 0 1 1-2 0zM7 9a1 1 0 0 1 2 0v3a1 1 0 1 1-2 0z" />
                                <path d="M4 1.5H3a2 2 0 0 0-2 2V14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V3.5a2 2 0 0 0-2-2h-1v1h1a1 1 0 0 1 1 1V14a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V3.5a1 1 0 0 1 1-1h1z" />
                                <path d="M9.5 1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5zm-3-1A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0z" />
                            </svg>
                            <h3 class="mb-0">Historial de clases</h3>
                        </div>
                        <p class="text-center text-lg-start">Vista general de tu historial de clases.</p>
                        ...
                        <div id="header-tabla" class="d-flex flex-wrap flex-lg-nowrap justify-content-between align-items-center shadow bg-body-tertiary">
                            ...
                            <!-- select agregar instructor -->
                            <div class="p-2 d-flex w-100">
                                <div class="p-2 d-flex align-items-center w-100 w-lg-auto">
                                    <span class="me-2">Clases:</span>
                                    <select id="filtroClases" class="form-select me-2">
                            ...
                            <div class="p-2 w-100 w-lg-auto">
                                <input type="date" id="searchDate" class="form-control w-100 w-lg-auto" placeholder="Buscar por fecha...">
                            </div>
                        ...
                        <div class="table-responsive shadow">
                            <table id="tablaHistorialClases" class="table table-striped table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="border-0">Nombre de Estudiante</th>
                                        <th scope="col" class="border-0">Apellido de Estudiante</th>
                                        <th scope="col" class="border-0">Teléfono de Estudiante</th>
                                        <th scope="col" class="border-0">Título de clase</th>
                                        <th scope="col" class="border-0">Nota</th>
                                        <th scope="col" class="border-0">Descripción de nota</th>
                ...
                <div class="modal-body">
                    <form id="formModificarInstructor" method="post" onsubmit="guardarCambios(event)">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <label for="txtNota">Pass</label>
                        </div>

                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="txtNotaDescripcion" name="horasDictadas" required>
                            <label for="txtNotaDescripcion">Horas Dictadas</label>
                        </div>
    ...
    <script src="js/historial-clases-instructor.js"></script>
