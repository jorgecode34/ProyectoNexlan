                    ...
                    <div class="mb-3">
                        ...
                        <div id="header-tabla" class="d-flex flex-wrap flex-lg-nowrap justify-content-between align-items-center shadow bg-body-tertiary">
                            ...
                            <div class="me-auto p-2 w-100 w-lg-auto">
                                <button class="btn btn-primary w-100 w-lg-auto" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">Agregar vehículo</button>
                            </div>
                            <!-- Barra de búsqueda -->
                            <div class="p-2 w-100 w-lg-auto">
                                <input type="search" id="searchInput" class="form-control w-100 w-lg-auto" placeholder="Buscar vehículos...">
                            </div>
                            <!-- Boton limitar -->
                            ...
                            <div class="modal-dialog modal-dialog-scrollable">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="alta-vehiculo.php" method="post" onsubmit="disableSubmitButton()">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-info" onclick="rellenarCamposVehiculo()">Rellenar con datos aleatorios</button>
...
<!-- Modal modificar vehículo -->
<div class="modal fade" id="modifModal" tabindex="-1" aria-labelledby="modalModificarLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">

            <div class="modal-header">
                <h5 class="modal-title" id="modalModificarLabel">Modificar Vehículo</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <div class="modal-body">
                <form id="formModificarVehiculo" method="post" onsubmit="guardarCambios(event)">

                    <input type="hidden" id="txtIDVehiculos" name="ID_Vehiculos">

                        <input type="hidden" id="txtMatricula" name="Matricula">

                        <input type="hidden"  id="txtTipoId" name="tipoId" >

                        <input type="hidden"  id="txtModelo" name="Modelo" >

                        <input type="hidden"  id="txtMarca" name="Marca" >

                    <div class="form-floating mb-3">
                        <input type="number" class="form-control" id="txtAnioFabricacion" name="AnioFabricacion" required>
                        <label for="txtAnioFabricacion">Año de Fabricación</label>
                    </div>

                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="txtColor" name="Color" required>
                    ...
                    <div class="form-floating mb-3">
                            <select class="form-select" id="txtEstado" name="Estado" required>
                    ...
                    <div class="form-floating mb-3">
                        <input type="number" class="form-control" id="txtKilometraje" name="kilometraje" required>
...
<div class="modal fade" id="modalBaja" tabindex="-1" aria-labelledby="modalBajaLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>¿Estás seguro de que deseas dar de baja a este vehículo? Esta acción es irreversible, pero quedará un registro en la base de datos.</p>
            </div>
            <div class="modal-footer">
                <form id="formBajaVehiculo" method="post" onsubmit="confirmarBaja(event)">
                    <input type="hidden" id="bajaMatricula" name="Matricula">
