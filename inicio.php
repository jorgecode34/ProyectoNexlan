...
<body class="dashboard-page" data-bs-theme="auto">
                ...
                <div class="container-fluid">
                    <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-center justify-content-lg-start">
                            <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" fill="currentColor" class="bi bi-house-door-fill me-2" viewBox="0 0 16 16">
                                <path d="M6.5 14.5v-3.505c0-.245.25-.495.5-.495h2c.25 0 .5.25.5.5v3.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5" />
                            </svg>
                        ...
                        <p class="text-center text-lg-start">Vista general rápida de la academia.</p>
                                        ...
                                        <div class="row">
                                                        ...
                                                        <div class="row g-0 align-items-center">
                                                            <div class="col me-2">
                                                                ...
                                                                <div class="h5 mb-0 fw-bold text-gray-800 number-display">
                                                                    ...
                                                                    <?php
                                                                    $totalEstudiantes = $controlador->listarTotalEstudiantes();
                        
                                                                    if ($totalEstudiantes) {
                                                                        echo $totalEstudiantes['total_estudiantes'];
                                                                    } else {
                                                                        echo "<p>Error al obtener el total de estudiantes.</p>";
                                                                    }
                                                                    ?>
                                                            ...
                                                            <div class="col-auto">
                                                                <svg xmlns="http://www.w3.org/2000/svg" id="iconoEstudiante" width="50" height="50" class="bi bi-people" viewBox="0 0 16 16">
                                                                    <path fill="--bs-primary" d="M15 14s1 0 1-1-1-4-5-4-5 3-5 4 1 1 1 1zm-7.978-1L7 12.996c.001-.264.167-1.03.76-1.72C8.312 10.629 9.282 10 11 10c1.717 0 2.687.63 3.24 1.276.593.69.758 1.457.76 1.72l-.008.002-.014.002zM11 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4m3-2a3 3 0 1 1-6 0 3 3 0 0 1 6 0M6.936 9.28a6 6 0 0 0-1.23-.247A7 7 0 0 0 5 9c-4 0-5 3-5 4q0 1 1 1h4.216A2.24 2.24 0 0 1 5 13c0-1.01.377-2.042 1.09-2.904.243-.294.526-.569.846-.816M4.92 10A5.5 5.5 0 0 0 4 13H1c0-.26.164-1.03.76-1.724.545-.636 1.492-1.256 3.16-1.275ZM1.5 5.5a3 3 0 1 1 6 0 3 3 0 0 1-6 0m3-2a2 2 0 1 0 0 4 2 2 0 0 0 0-4" />
                                                                </svg>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="row g-0 align-items-center">
                                                            <div class="col me-2">
                                                                ...
                                                                <div class="h5 mb-0 fw-bold text-gray-800 number-display">
                                                                    ...
                                                                    <?php
                                                                    $totalInstructores = $controlador->listarTotalInstructores();
                                                                    if ($totalInstructores) {
                                                                        echo $totalInstructores['total_instructores'];
                                                                    } else {
                                                                        echo "<p>Error al obtener el total de instructores.</p>";
                                                                    }
                                                                    ?>
                                                            ...
                                                            <div class="col-auto">
                                                                <svg xmlns="http://www.w3.org/2000/svg" id="iconoInstructor" width="50" height="50" class="bi bi-people" viewBox="0 0 16 16">
                                                                    <path d="M15 14s1 0 1-1-1-4-5-4-5 3-5 4 1 1 1 1zm-7.978-1L7 12.996c.001-.264.167-1.03.76-1.72C8.312 10.629 9.282 10 11 10c1.717 0 2.687.63 3.24 1.276.593.69.758 1.457.76 1.72l-.008.002-.014.002zM11 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4m3-2a3 3 0 1 1-6 0 3 3 0 0 1 6 0M6.936 9.28a6 6 0 0 0-1.23-.247A7 7 0 0 0 5 9c-4 0-5 3-5 4q0 1 1 1h4.216A2.24 2.24 0 0 1 5 13c0-1.01.377-2.042 1.09-2.904.243-.294.526-.569.846-.816M4.92 10A5.5 5.5 0 0 0 4 13H1c0-.26.164-1.03.76-1.724.545-.636 1.492-1.256 3.16-1.275ZM1.5 5.5a3 3 0 1 1 6 0 3 3 0 0 1-6 0m3-2a2 2 0 1 0 0 4 2 2 0 0 0 0-4" />
                                                                </svg>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-xl-3 col-md-6 col-6 mb-4">
                                                <div class="card border-start-primary shadow h-100 custom-border-radius">
                                                    <div class="card-body">
                                                        <div class="row g-0 align-items-center">
                                                            <div class="col me-2">
                                                                <div class="text-xs fw-bold text-success text-uppercase mb-1 custom-title">Estudiantes con Teórico Aprobado</div>
                                                                <div class="h5 mb-0 fw-bold text-gray-800 number-display">
                        
                                                                    <?php
                                                                    $totalEstudiantesAprobados = $controlador->listarTotalEstudiantesAprobados();
                                                                    if ($totalEstudiantesAprobados) {
                                                                        echo $totalEstudiantesAprobados['total_estudiantes_aprobados'];
                                                                    } else {
                                                                        echo "<p>Error al obtener el total de estudiantes aprobados.</p>";
                                                                    }
                                                                    ?>
                                                            ...
                                                            <div class="col-auto">
                                                                <svg xmlns="http://www.w3.org/2000/svg" id="iconoTeorico" width="50" height="50" class="bi bi-clipboard2-check" viewBox="0 0 16 16">
                                                    ...
                                                    <a href="estudiante.php?search=aprobado" class="btn btn-success mt-auto py-1 rounded-bottom text-white">Ver más</a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-3 col-md-6 col-6 mb-4">
                                                <div class="card border-start-primary shadow h-100 custom-border-radius">
                                                    <div class="card-body">
                                                        <div class="row g-0 align-items-center">
                                                            <div class="col me-2">
                                                                <div class="text-xs fw-bold text-info text-uppercase mb-1 custom-title">Vehículos en Mantenimiento</div>
                                                                <div class="h5 mb-0 fw-bold text-gray-800 number-display">
                        
                                                                    <?php
                                                                    $totalVehiculosMantenimiento = $controlador->listarTotalVehiculosMantenimiento();
                                                                    if ($totalVehiculosMantenimiento) {
                                                                        echo $totalVehiculosMantenimiento['total_vehiculos_mantenimiento'];
                                                                    } else {
                                                                        echo "<p>Error al obtener el total de vehículos en mantenimiento.</p>";
                                                                    }
                                                                    ?>
                                                            ...
                                                            <div class="col-auto">
                                                                <svg xmlns="http://www.w3.org/2000/svg" id="iconoVehiculo" width="50" height="50" class="bi bi-car-front" viewBox="0 0 16 16">
                                                                    <path d="M4 9a1 1 0 1 1-2 0 1 1 0 0 1 2 0m10 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0M6 8a1 1 0 0 0 0 2h4a1 1 0 1 0 0-2zM4.862 4.276 3.906 6.19a.51.51 0 0 0 .497.731c.91-.073 2.35-.17 3.597-.17s2.688.097 3.597.17a.51.51 0 0 0 .497-.731l-.956-1.913A.5.5 0 0 0 10.691 4H5.309a.5.5 0 0 0-.447.276" />
                                                                    <path d="M2.52 3.515A2.5 2.5 0 0 1 4.82 2h6.362c1 0 1.904.596 2.298 1.515l.792 1.848c.075.175.21.319.38.404.5.25.855.715.965 1.262l.335 1.679q.05.242.049.49v.413c0 .814-.39 1.543-1 1.997V13.5a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1-.5-.5v-1.338c-1.292.048-2.745.088-4 .088s-2.708-.04-4-.088V13.5a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1-.5-.5v-1.892c-.61-.454-1-1.183-1-1.997v-.413a2.5 2.5 0 0 1 .049-.49l.335-1.68c.11-.546.465-1.012.964-1.261a.8.8 0 0 0 .381-.404l.792-1.848ZM4.82 3a1.5 1.5 0 0 0-1.379.91l-.792 1.847a1.8 1.8 0 0 1-.853.904.8.8 0 0 0-.43.564L1.03 8.904a1.5 1.5 0 0 0-.03.294v.413c0 .796.62 1.448 1.408 1.484 1.555.07 3.786.155 5.592.155s4.037-.084 5.592-.155A1.48 1.48 0 0 0 15 9.611v-.413q0-.148-.03-.294l-.335-1.68a.8.8 0 0 0-.43-.563 1.8 1.8 0 0 1-.853-.904l-.792-1.848A1.5 1.5 0 0 0 11.18 3z" />
                                                                </svg>
                                                            </div>
                                                    ...
                                                    <a href="vehiculo.php?search=En%20mantenimiento" class="btn btn-info mt-auto py-1 rounded-bottom text-white">Ver más</a>
                                                </div>
                                            </div>
                        
                                            <!-- Gráfica monto por mes -->
                                            <div class="col-xl-12 col-md-12 mb-4">
                                                <div class="card border-start-primary shadow custom-border-radius">
                                                    <div class="card-body">
                                                        <div class="row g-0 align-items-center">
                                                            <div class="col me-2">
                                            ...
                                            <div class="col-xl-4 col-md-6 mb-4">
                                                ...
                                                <div class="card border-start-primary shadow custom-border-radius h-70">
                                                    <div class="card-body">
                                                        <div class="row g-0 align-items-center">
                                                            <div class="col me-2">
                                            ...
                                            <div class="col-xl-4 col-md-12 mb-4">
                                                <!-- Ingresos totales -->
                                                <div class="card border-start-primary shadow custom-border-radius mb-4">
                                                    <div class="card-body">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div class="me-2">
                                                                <div class="text-xs fw-bold text-danger text-uppercase mb-1 custom-title">Ingresos totales</div>
                                                                <div class="h5 mb-0 fw-bold text-gray-800 number-display">
                                                                    <?php
                                            ...
                                            <!-- <div class="col-xl-8 col-md-6 mb-4">
                                                <div class="card border-start-primary shadow h-100">
                                                    <div class="card-body d-flex justify-content-center align-items-center">
                                                        <div class="col me-2">
                                                            <canvas id="costChart" class="w-100 h-100"></canvas>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div> -->
