...
<body class="dashboard-page">
    ...
    <div class="wrapper">
            ...
            <div class="sidebar-scroll">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        ...
                        <a href="configuracion-estudiante.php" class="sidebar-link">
                    ...
                    <li class="sidebar-item separar-items">
                        <a href="estudiante-material.php" class="sidebar-link">
        ...
        <div class="main">
            ...
            <nav class="navbar navbar-expand shadow-sm px-3 border-bottom fixed-nav bg-body-tertiary">
                ...
                <div class="ms-auto search-icon-container" id="siclaro" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <div class="card border-start-primary shadow h-100 custom-title custom-border-radius">
                            <div class="card-body">
                                <div class="row g-0 align-items-center">
                                    <div class="col me-2">
                                        <div class="text-xs fw-bold text-success text-uppercase mb-1 custom-title">Cantidad de clases prácticas completadas</div>
                                        <div class="h5 mb-0 fw-bold text-gray-800 number-display">

                                            <?php
                                            $totalVehiculosMantenimiento = $controlador->cantidadClasesPasadasEstudiante($usuarioEmail);
                                            if ($totalVehiculosMantenimiento) {
                                                echo $totalVehiculosMantenimiento['clases_pasadas'] . ' / 15';
                                            } else {
                                    ...
                                    <div class="col-auto">
                                        <svg xmlns="http://www.w3.org/2000/svg" id="iconoTeorico" width="50" height="50" fill="currentColor" class="bi bi-check-lg" viewBox="0 0 16 16">
                                            <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425z"/>
                                        </svg>
                                    </div>
                                </div>
                            </div>
                            <a href="clases-estudiante.php" class="btn btn-success mt-auto py-1 rounded-bottom text-white">Ver más</a>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        <div class="card border-start-primary shadow h-100 custom-border-radius">
                            <div class="card-header">
                                <h5 class="card-title py-2 text-center">Información de instructores asignados</h5>
    ...
    <script src="js/datosInstructoresAsignados.js"></script>
