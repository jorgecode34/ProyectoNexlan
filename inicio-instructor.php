...
<body class="dashboard-page">
            ...
            <div class="sidebar-scroll">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item separar-items active-link">
                        ...
                        <a href="inicio-instructor.php" class="sidebar-link selected">
                    ...
                    <li class="sidebar-item separar-items">
                        <a href="clases-instructor.php" class="sidebar-link separar-items">
                                ...
                                <div class="card border-start-primary shadow h-100 custom-title custom-border-radius">
                                    ...
                                    <div class="card-body">
                                        <div class="row g-0 align-items-center">
                                            <div class="col me-2">
                                                <div class="text-xs fw-bold text-primary text-uppercase mb-1">Clases agendadas hoy</div>
                                                <div class="h5 mb-0 fw-bold text-gray-800 number-display">

                                                    <?php
                                                    $clasesHoy = $controlador->clasesAgendadasHoy($usuarioEmail);

                                                    if ($clasesHoy) {
                                                        echo $clasesHoy['total_clases'];
                                                    } else {
                                                        echo "<p>Error al obtener el total de clases de hoy.</p>";
                                                    }
                                                    ?>
                                            ...
                                            <div class="col-auto">
                                                <svg xmlns="http://www.w3.org/2000/svg" id="iconoEstudiante" width="50" height="50" fill="currentColor" class="bi bi-calendar2-check-fill" viewBox="0 0 16 16">
                                                    <path d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5m9.954 3H2.545c-.3 0-.545.224-.545.5v1c0 .276.244.5.545.5h10.91c.3 0 .545-.224.545-.5v-1c0-.276-.244-.5-.546-.5m-2.6 5.854a.5.5 0 0 0-.708-.708L7.5 10.793 6.354 9.646a.5.5 0 1 0-.708.708l1.5 1.5a.5.5 0 0 0 .708 0z" />
                                                </svg>
                                            </div>
                                        </div>
                                    </div>
                                    <a href="clases-instructor.php" class="btn btn-primary mt-auto py-1 rounded-bottom">Ver más</a>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-6 col-md-6 col-6 mb-4">
                                <div class="card border-start-primary shadow h-100 custom-title custom-border-radius">
                                    <div class="card-body">
                                        <div class="row g-0 align-items-center">
                                            <div class="col me-2">
                                                <div class="text-xs fw-bold text-warning text-uppercase mb-1 custom-title">Clases agendadas del mes</div>
                                                <div class="h5 mb-0 fw-bold text-gray-800 number-display">

                                                    <?php
                                                    $clasesMes = $controlador->clasesAgendadasMes($usuarioEmail);
                                                    if ($clasesMes) {
                                                        echo $clasesMes['clases_mes'];
                                                    } else {
                                                        echo "<p>Error al obtener el total de clases del mes.</p>";
                                                    }
                                                    ?>
                                            ...
                                            <div class="col-auto">
                                                <svg xmlns="http://www.w3.org/2000/svg" id="iconoInstructor" width="50" height="50" fill="currentColor" class="bi bi-calendar3" viewBox="0 0 16 16">
                                    ...
                                    <a href="clases-instructor.php" class="btn btn-warning mt-auto py-1 rounded-bottom text-white">Ver más</a>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                <div class="card border-start-primary shadow h-100 custom-border-radius">
                                    <div class="card-header">
                                        <h5 class="card-title py-2 text-center">Información de estudiantes asignados</h5>
                                        <ul class="nav nav-pills card-header-pills justify-content-center" id="navTab" role="tablist">
                                        </ul>
                                    </div>
                                    <div class="tab-content text-center" id="navContent">
                                    </div>
                                </div>
                            </div>
    ...
    <script src="js/datosEstudiantesAsingados.js"></script>
