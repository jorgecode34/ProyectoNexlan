...
async function traerUsuarios() {
    const response = await fetch('traerInstructoresAsignados.php', {
        method: 'GET'
    })
 ...
 * @param {Object} infoPersona - Información del instructor
    ...
    const content = `
        <div class="tab-pane fade" 
            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-6">
                        <h5 class="card-title">Información del instructor</h5>
